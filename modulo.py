def separa_idosos(pessoas:dict,idade_para_ser_idoso:int)->dict:
    """
    Separa os idosos em uma lista que está dentro de um dicionário.
    Parametro pessoas: possui as pessoas para serem separadas 
    Parametro idadae : é com quantos anos alguém é idoso.
...
def fila_prioridade_por_idosos(pessoas:dict, condição_de_ordenação_fila:int)->list:
    """
    ...
    pessoas = {
        'maiores_60':pessoas['maiores_60'].copy(),
        'menores_60':pessoas['menores_60'].copy()
        }
...
def mostra_tabela_idosos(pessoas:dict):
    """
